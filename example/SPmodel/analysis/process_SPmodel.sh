...
#SBATCH --job-name SPmod_proc
#SBATCH --output SPmod_proc-%J.log
...
echo "2" | gmx_mpi trjconv -f after_rot_example.xtc -s SP_dsAXA.pdb -n SP_index.ndx -o S_traj.g96

echo "3" | gmx_mpi trjconv -f after_rot_example.xtc -s SP_dsAXA.pdb -n SP_index.ndx -o P_traj.g96

# 3.
gmx_mpi sasa -f after_rot_example.xtc -s SP_dsAXA.pdb -n SP_index.ndx -or SP_resarea.xvg -dt 1000 -surface 1 -output 2 3
...
echo "Sugar trajectory converted to .npy file!"
