...
print('Done loading and saving P model trajectory!')

le4pd_extras.save_single_particle_traj('tcfrun/', P_com_ftraj, 46)

Umat, Rinv, avbl, avblsq =  le4pd.Umatrix(P_com_ftraj, SYS, N, NFRS, nmol, nres_list)
...
fratio, sigma, fric, avfr = le4pd_extras.fric_calc_Pmodel('P_model.pdb', SYS, N, NFRS, avblsq, T=300, intv = 2.71828, viscosity = 3.1e-4, fd20 = 0.0, path_to_resarea = './', cgmodel = 'P')
...
barlist, xi, dummy = le4pd.mode_mad(P_com_ftraj, SYS, N, NFRS, nmol, nres_list, Q_sorted, QINV_sorted, T, nmodes = 10)
